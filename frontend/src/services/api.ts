...
// For production deployments, use environment variable or default to backend deployment URL
const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'https://your-backend-deployment-url.replit.app/api';
